...
joiner <- joiner |>
    ...
    # make Month YYYY
    # rename(
    #     "Number of Car Thefts" = car_theft,
    #     "Number of Car Related Adult Arrests" = car_arrests,
    #     "Number of Car Related Juvenile Arrests" = car_arrests_juvenile
    # )
...
Plot.plot({
  ...
  title_font: {size: 20, family: "Impact"},
  title: "Percent Change in Car Thefts and Related Arrests\nin DC from 2019 to 2023",
  legend: {label: "Type", title: "Type"},
  // change the color of the lines with hex values
  color: {range: ["#D34B7F", "#493FB3", "#FFBF49"]},
  marks: [
    Plot.ruleY([0]),
...
Inputs.table(
    joiner_df,
    {columns: ["Month", "car_theft", "car_arrests", "car_arrests_juvenile"], 
    header: {
        car_theft: "Car Thefts",
        car_arrests: "Car Related Adult Arrests",
        car_arrests_juvenile: "Car Related Juvenile Arrests"
    },
    title: "Number of Car Thefts and Related Arrests in DC from 2019 to 2023"
    }
)
```