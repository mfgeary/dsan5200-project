...
color_palette = ['#00c0a7', '#44546a', '#ff6c00', '#FF818E', '#FFD072']
...
fig = px.line(yearly_hourly_theft_counts, x='hour_of_day', y='Number of Car Thefts', color='year',
              title='Total DC Car Theft Activity by Hour of the Day for Each Year (2019-2023)',
...
fig.update_layout(
    ...
    xaxis=dict(title_font=dict(family="Impact")),  
    yaxis=dict(title_font=dict(family="Impact"))   
)
