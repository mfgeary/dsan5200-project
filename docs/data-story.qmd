    ...
    html:
      ...
      code-links:
        - text: GitHub Repository
          icon: github
          href: https://github.com/gu-dsan5200/spring-2024-dsan-5200-project-repo-project-group-02
grid:
    body-width: 1100px
theme: 
  - lux
...
toc: true
nocite: |
  @dc-maps, @dc-crime-data-2023, @dc-crime-data-2022, dc-crime-data-2021, @dc-crime-data-2020, @dc-crime-data-2019, @adult-arrests-2023, @adult-arrests-2022, @adult-arrests-2021, @adult-arrests-2020, @adult-arrests-2019, @juvenile-arrests-2023-2, @juvenile-arrests-2023-1, @juvenile-arrests-2022-2, @juvenile-arrests-2022-1, @juvenile-arrests-2021-2, @juvenile-arrests-2021-1, @juvenile-arrests-2020-2, @juvenile-arrests-2020-1, @juvenile-arrests-2019-2, @juvenile-arrests-2019-1,
  @wards-data, @demographics-wards, @scrolly-telling-help
vega:
  renderer:
    css: |
...
::: {.column-screen style="background-size: cover; height: 35vh; position: sticky; top: 0;"}

![](content/washington-dc-mall-sunrise.jpeg)
...
```{python, fig.width = 14}
#| label: fig-heatmap-slider
#| fig-cap: "From 2019-2023, the Kias and Hyundais are stolen at an increasing rate, showing the negative impact of the Kia Boys trend on the car theft rate in the US. Source: VICE NEWS Kia and Hyundai Theft Data"
#| fig-align: center

import plotly.express as px

kia_hyundai = pd.read_csv('../../data/clean/kia_hyundai_thefts_data.csv')
kia_hyundai['year_month'] = kia_hyundai['year'].astype(str).str.split('.').str[0] + '-' + kia_hyundai['month']
...
fig = px.density_mapbox(kia_hyundai, lat='lat', lon='long', z='percent_kia_hyundai',
                        ...
                        title='Percentage of Kia-Hyundai Thefts in the US by Month and Year (2019-2023)',
...
![](../../data/DC_Ward_Map_2020s.png){fig-align="center" fig-valign="center"}
