...
::: {.column-screen style="background-image:url(https://vastphotos.com/files/uploads/photos/11330/washington-dc-mall-sunrise-l.jpg?v=20221018121735); background-size: cover; height: 60vh; position: sticky; top: 0; "}
:::
...
::: {.column width = "50%" style="padding:20px; position:sticky;top:100px;"}
